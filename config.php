...
define('USERNAME', "sahari.letters@gmail.com");
 
// Define your 16 digit Gmail app-password.
define('PASSWORD', "emmh gqca lsxv yqqs");
 
// Define the email address from which the email is sent.
define('SEND_FROM', "contact@saharitelugu.com");
 
// Define the name of the website from which the email is sent. 
define('SEND_FROM_NAME', "saharitelugu.com");
 
// Define the reply-to address.
define('REPLY_TO', "contact@saharitelugu.com");
 
// Define the reply-to name.
define('REPLY_TO_NAME', "Sahari");